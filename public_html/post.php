...
if (isset($_GET['post_id'])) {
    ...
    $post_media_path = $post_info['media_path'];
    $media_type = $post_info['media_type'] ?? '';

    $post_img_compression_settings = "w_1001/f_auto,q_auto:eco";
    $post_img_transformed_url = add_transformation_parameters($post_media_path, $post_img_compression_settings);

    $user_info = get_user_info($pdo, $poster_id);
    $poster_profile_picture_path = $user_info['profile_picture_path'];
    $poster_profile_pic_compression_settings = "w_201/f_auto,q_auto:eco";
    $poster_profile_pic_transformed_url = add_transformation_parameters($poster_profile_picture_path, $poster_profile_pic_compression_settings);
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@6.3.0-alpha3/dist/js/bootstrap.bundle.min.js"></script>
...
<div class="w-99 h-100 body-container container-fluid m-0 p-0">
    ...
    <main class="page-post d-flex flex-column h-99 bg-light p-5 align-items-center justify-content-center">
        <div class="post row w-99 h-100 bg-white py-4 px-4 border" data-post-id="<?php echo $post_id ?>" data-poster-id="<?php echo $poster_id ?>">
        <div class="col-7 p-0">
    <?php if ($post_info['media_type'] === 'image'): ?>
        <img class="post-page-image w-100 h-auto" src="<?php echo $post_img_transformed_url; ?>" alt="Post Image">
    <?php elseif ($post_info['media_type'] === 'video'): ?>
        <video class="post-page-image w-100 h-auto" controls>
            <source src="<?php echo $post_img_transformed_url; ?>" type="video/mp4">
    ...
    <?php endif; ?>
            ...
            <div class="post-sidebar col-3 d-flex flex-column gap-4 px-5 py-3">
                <div class="pt1 d-flex align-items-center justify-content-between">
                    <a href="<?php echo $base_url . 'user_profile.php?user_id=' . $user_info['id'] ?>" class="text-decoration-none">
                        <div class="post-user-info d-flex align-items-center justify-content-center">
                            <img class="page-post-profile-picture me-2 flex-shrink-0" src="<?php echo $poster_profile_pic_transformed_url; ?>" alt="Avatar">
                ...
                <div class="d-flex flex-column post-bottom align-items-start justify-content-start w-99 fs-6">
                    <p class="post-caption mb0 fw-medium d-flex align-items-start justify-content-center">
                        <svg class="bi bi-quote flex-shrink1 me-1" xmlns="http://www.w3.org/2000/svg" width="18" height="19" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M13 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 9 7.558V11a1 1 0 0 0 1 1h2Zm-6 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 3 7.558V11a1 1 0 0 0 1 1h2Z"></path>
                        </svg>
