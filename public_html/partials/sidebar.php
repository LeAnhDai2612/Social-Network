    ...
    <div class="d-flex flex-column position-sticky h-100 w-100">
        <div class="sidebar-container d-flex flex-column h-100 pt-5 pb-4">
                ...
                <a href="<?php echo $user_profile_link; ?>" class="text-decoration-none">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="m-0 text-secondary">
                            <?php echo strval($user_post_count) === '1' ? 'Bài đăng' : 'Bài viết' ?>
                        </p>
                    </div>
                </a>
            ...
            <ul class="navbar-menu-links-container d-flex flex-column navbar-nav w-100 ps-0 mb-5">
                ...
                <li class="nav-item d-flex align-items-center <?php echo ($active_page === 'inbox') ? 'fw-semibold active' : ''; ?>">
    <a class="nav-link d-flex px-2 ms-5 w-100" href="inbox.php">
        <i class="nav-link-icon bi <?php echo ($active_page === 'inbox') ? 'bi-chat-fill' : 'bi-chat'; ?> me-4 d-flex align-items-center justify-content-center"></i>
        Tin nhắn
    </a>
</li>
